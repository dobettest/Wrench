export var primitiveTypes = ["string", "number", "null", "undefined", "binint", "boolean"];
export var refercenceTypes = ["RegExp", "Date", "Object", "Function", "Array"];
/**
 ...
 * @returns string
 */
export function wrapperNumber(num, len) {
    if (len === void 0) { len = 3; }
 ...
 * @returns boolean
 */
export function isPrimitiveValue(params) {
    return primitiveTypes.some(function (type) { return typeof params === type; });
}
/**
 * @description 获取数据类型
 * @param param any
...
export function getType(param) {
    if (isPrimitiveValue(param)) {
        ...
        return refercenceTypes.find(function (type) { return str_1 === "[object ".concat(type, "]"); }) || str_1;
    }
}
/**
 ...
 * @returns 修改后的值
 */
export function expandFn(initialValue, effect) {

...
exports.grantPermission = exports.checkPermission = exports.permission = void 0;
/**
 ...
 * @returns 是否具有权限
 */
function checkPermission(operation, permissionCode, delimiter) {
 ...
 */
function grantPermission(operation, permissionCode, delimiter, authorId) {
    if (delimiter === void 0) { delimiter = ":"; }
